...
function check_time($day)
{
    ...
    unset($st);
    $st = array();
    $query3 = "SELECT * FROM bat_c_04 ORDER BY id asc";
...
<body style="font-family: 'Prompt', sans-serif;">
    <div class="contianer">
        <div class="row menu-bar" align="center">
            <form class="time-form" action="book_04.php" method="POST">
                <div class="row">
                    <div class="col" style="margin-left: -50px;">
                        <p class="text-menu"> เลือกสนาม </p>
                        <label class="form-control" style="margin-left: 250px; width: 400px;">สนามที่4</label>
                    </div>
    ...
    <div class="container time-table">
        <div class="booking">
            <h3 class="text-menu">ตารางการใช้งานสนานที่ 4</h3>
        </div>
        <table class="table table-borderless">
            ...
            <tbody>
                <tr align="center" class="text-menu">
                    <th scope="row">Sun</th>
                    <?php check_time("Sun"); ?>
                </tr>
                <tr class="text-menu" align="center">
                    <th scope="row">Mon</th>
                    <?php check_time("Mon"); ?>
                </tr>
                <tr class="text-menu" align="center">
