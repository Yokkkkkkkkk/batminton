...
function check_time($day)
{
    ...
    unset($st);
    $st = array();
    $query3 = "SELECT * FROM bat_c_03 ORDER BY id asc";
...
<body style="font-family: 'Prompt', sans-serif;">
    <div class="contianer">
        <div class="row menu-bar" align="center">
            <form class="time-form" action="book_03.php" method="POST">
                <div class="row">
                    <div class="col" style="margin-left: -50px;">
                        <p class="text-menu"> เลือกสนาม </p>
                        <label class="form-control" style="margin-left: 250px; width: 400px;">สนามที่3</label>
                    </div>
    ...
    <div class="container time-table">
        <div class="booking">
            <h3 class="text-menu">ตารางการใช้งานสนานที่ 3</h3>
        </div>
